...
def train(args):
    ...
    train_loader, val_loader, _, train_sampler = get_data(
        args,
        is_distributed=True
    )
    ...
    # =====================================================
    # VAE (frozen — apenas para decode na geração)
    # =====================================================
    ...
    # Fixed attributes para geração consistente (só master precisa)
    fixed_attrs = None
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        for i, (latents, attrs) in enumerate(pbar):

            latents = latents.to(device, non_blocking=True)
            attrs = attrs.to(device, non_blocking=True)

            # Guarda atributos fixos para sampling consistente
        ...
        with torch.no_grad():
            ...
            for latents, attrs in val_loader:
        ...
        # Agrega val loss de todos os GPUs
