...
from models.modules import ResidualBlock, Upsample, Downsample, AttentionBlock, SinusoidalPosEmb, CrossAttentionBlock
...
class UNet_cond(nn.Module):
    def __init__(
        ...
        self.cond_proj = nn.Conv2d(in_channels, base_channels, 1)
        #encoder
        ...
        self.mid = nn.ModuleList([
            ...
            ResidualBlock(curr_channels, curr_channels, time_dim, dropout),
            CrossAttentionBlock(curr_channels, cond_dim=3*256)
        ])
